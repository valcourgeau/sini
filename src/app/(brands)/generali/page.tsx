      ...
      >
        ...
        <div className="container relative z-10 mx-auto">
          <div className="mx-auto max-w-4xl text-center px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
            ...
            {/* Enhanced title with Generali branding and responsive scaling */}
            <div className="mb-6 sm:mb-8 lg:mb-12">
              ...
              <div className="flex items-center justify-center gap-2 mt-3 sm:mt-4">
                ...
                <span className="text-lg sm:text-xl font-bold text-primary-foreground drop-shadow-xl">Generali</span>
              </div>
            </div>
            ...
            {/* Enhanced action buttons with Generali glass effect and responsive grid */}
