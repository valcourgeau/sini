...
export default function VaudoiseHomePage() {
  ...
  return (
    <main className="min-h-screen scroll-smooth">
          ...
          <div className="mx-auto max-w-[980px] text-center">
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center justify-center gap-2 mt-4">
                <span className="text-lg text-primary font-semibold">Partenaire officiel</span>
                <span className="text-xl font-bold text-primary">Vaudoise Assurances</span>
              </div>
            </div>
      ...
      {/* Second Section - Vaudoise Green Background */}
      ...
      {/* Third Section - Vaudoise Light Green Background */}
      ...
      {/* Fourth Section - Vaudoise Green Background */}
